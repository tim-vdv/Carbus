...
{
    public partial class ucFactuurTeFactureren : UserControl
    {
        ...
        public ucFactuurTeFactureren()
        {
            InitializeComponent();

            //MainForm.updateStatus = "Facturen te factureren";
        }
        private void btnOphalen_Click(object sender, EventArgs e)
        {
            ...
            foreach (opdracht opdracht in FactuurManagement.getTeFacturerenOpdrachten(cbbTotDatum.Value))
            {
                ucFactuurMini2 uco = new ucFactuurMini2();
        ...
        {
            ucFactuurMini2 control = (ucFactuurMini2)sender;
