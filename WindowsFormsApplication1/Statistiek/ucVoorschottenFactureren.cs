...
{
    public partial class ucVoorschottenFactureren : UserControl
    {
        ...
        public ucVoorschottenFactureren()
        {
            InitializeComponent();
        ...
        private void SelectionChanged() {
            ...
            //dataGridView1.DataSource = FactuurManagement.getTeFacturerenVoorschotten(dateTimePicker1.Value);
        ...
        private void btn_printToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //DataTable table = (DataTable)FactuurManagement.getTeFacturerenVoorschotten(dateTimePicker1.Value);
                //writer.write(table);
            }
            catch { 
