...
{
    public partial class ucFactuurTeBetalen : UserControl
    {
        ...
        public ucFactuurTeBetalen()
        {
            InitializeComponent();

            //MainForm.updateStatus = "Facturen te betalen";
        }
        private void btnOphalen_Click(object sender, EventArgs e)
        {
            ...
            foreach (opdracht opdracht in FactuurManagement.getTeBetalenFacturen(cbbTotDatum.Value))
            {
